/*
** Função : Verifica se dois números são amigáveis,  além disso, verifica todos os pares de números amigáveis até um determinado valor n que será fornecido pelo usuário.
